...
with self; {
  ...
  backports-asyncio-runner =
    ...
    then null
    else callPackage ../development/python-modules/backports-asyncio-runner {};
  ...
  backports-strenum =
    if pythonAtLeast "3.11"
    then null
    else callPackage ../development/python-modules/backports-strenum {};

  backports-tarfile = callPackage ../development/python-modules/backports-tarfile {};

  backports-zstd =
    if pythonAtLeast "3.14"
    then null
    else
  ...
  cffi =
    if isPyPy
    then null
    else callPackage ../development/python-modules/cffi {};
  ...
  inherit
    (callPackage ../development/python-modules/geoarrow-rust {})
    geoarrow-rust-core
    geoarrow-rust-io
    ;
  ...
  itk = toPythonModule (
    pkgs.itk.override {
      ...
      stdenv =
        if stdenv.cc.isGNU
        then pkgs.stdenvAdapters.useLibsFrom stdenv pkgs.gcc13Stdenv
        else stdenv;
    }
  );
  ...
  legacy-cgi =
    if pythonOlder "3.13"
    then null
    else callPackage ../development/python-modules/legacy-cgi {};
  ...
  standard-cgi =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-cgi {}
    else null;
  ...
  standard-nntplib =
    if pythonOlder "3.13"
    then null
    else callPackage ../development/python-modules/standard-nntplib {};
  ...
  standard-sndhdr =
    if pythonAtLeast "3.13"
    then callPackage ../development/python-modules/standard-sndhdr {}
    else null;
  ...
  warp-lang = callPackage ../development/python-modules/warp-lang {
    stdenv =
      if stdenv.hostPlatform.isDarwin
      then pkgs.llvmPackages_19.stdenv
      else pkgs.stdenv;
